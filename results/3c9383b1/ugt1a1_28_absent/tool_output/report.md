...
**Input**: `ugt1a1_28_absent.txt`
**Format detected**: 23andme
**Checksum (SHA-256)**: `5dd46cd122b8aa902bad4a4ae6ccaa83640000751f78cd448d8926ef380caf44`
...
```bash
python pharmgx_reporter.py --input ugt1a1_28_absent.txt --output report
```

**Input checksum**: `5dd46cd122b8aa902bad4a4ae6ccaa83640000751f78cd448d8926ef380caf44`
