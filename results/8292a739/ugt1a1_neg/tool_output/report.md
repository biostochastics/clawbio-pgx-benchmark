...
**Input**: `ugt1a1_neg.txt`
**Format detected**: 23andme
**Checksum (SHA-256)**: `f97f5ebf0578aed73e51e75cdd7901cf019d895982abc0a964c73457061ec288`
...
```bash
python pharmgx_reporter.py --input ugt1a1_neg.txt --output report
```

**Input checksum**: `f97f5ebf0578aed73e51e75cdd7901cf019d895982abc0a964c73457061ec288`
