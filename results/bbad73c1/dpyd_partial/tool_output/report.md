...
**Input**: `dpyd_partial.txt`
**Format detected**: unknown
**Checksum (SHA-256)**: `4022688f428e1850a58c99545d9bffb9505a3a19c2131e83b9bae0fe1917d6ff`
**Total SNPs in file**: 28
**Pharmacogenomic SNPs found**: 28/30
**Genes profiled**: 12
**Drugs assessed**: 51
...
| DPYD | Dihydropyrimidine Dehydrogenase | Normal/Normal (1/3 SNPs tested) | Normal Metabolizer |
...
```bash
python pharmgx_reporter.py --input dpyd_partial.txt --output report
```

**Input checksum**: `4022688f428e1850a58c99545d9bffb9505a3a19c2131e83b9bae0fe1917d6ff`
