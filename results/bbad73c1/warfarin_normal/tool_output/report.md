...
**Input**: `warfarin_normal.txt`
**Format detected**: unknown
**Checksum (SHA-256)**: `7f84bda6188a5746b1b04ca8b6e6bed29c00b60228dfd4e324374ad0a7f0928b`
...
```bash
python pharmgx_reporter.py --input warfarin_normal.txt --output report
```

**Input checksum**: `7f84bda6188a5746b1b04ca8b6e6bed29c00b60228dfd4e324374ad0a7f0928b`
