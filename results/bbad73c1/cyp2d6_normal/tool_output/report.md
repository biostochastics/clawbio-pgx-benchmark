...
**Input**: `cyp2d6_normal.txt`
**Format detected**: unknown
**Checksum (SHA-256)**: `8531061b243583f86ad219e2b2784876a0ec3537ccfb2cb172d6eda05a390991`
...
```bash
python pharmgx_reporter.py --input cyp2d6_normal.txt --output report
```

**Input checksum**: `8531061b243583f86ad219e2b2784876a0ec3537ccfb2cb172d6eda05a390991`
