...
**Input**: `dpyd_2a_het.txt`
**Format detected**: unknown
**Checksum (SHA-256)**: `94e6e04443a956740b11fb4b5936b9c005ab550a587a537570139581dd8a4cbe`
...
- **Fluorouracil** (5-FU) [DPYD]: Reduce dose 50%. Monitor toxicity closely.
- **Capecitabine** (Xeloda) [DPYD]: Reduce dose 50%. Monitor toxicity.
...
| DPYD | Dihydropyrimidine Dehydrogenase | Normal/*2A | Intermediate Metabolizer |
...
| rs3918290 | DPYD | *2A | GT | no_function |
...
|------|-------|-------|------|--------|----------------|
| Capecitabine | Xeloda | Antineoplastic | DPYD | CAUTION | Reduce dose 50%. Monitor toxicity. |
| Fluorouracil | 5-FU | Antineoplastic | DPYD | CAUTION | Reduce dose 50%. Monitor toxicity closely. |
...
```bash
python pharmgx_reporter.py --input dpyd_2a_het.txt --output report
```

**Input checksum**: `94e6e04443a956740b11fb4b5936b9c005ab550a587a537570139581dd8a4cbe`
