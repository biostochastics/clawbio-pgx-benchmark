...
**Input**: `warfarin_missing_vkorc1.txt`
**Format detected**: unknown
**Checksum (SHA-256)**: `a5e24962b63d26f7a9fe76fce587ec5b92fefd2227ba8a1ca68d3842c35cc69b`
**Total SNPs in file**: 29
**Pharmacogenomic SNPs found**: 29/30
**Genes profiled**: 12
**Drugs assessed**: 51
...
**1 gene(s) could not be assessed** because the relevant SNPs were not found in the input file: VKORC1
...
| Warfarin | Coumadin | Anticoagulant | CYP2C9+VKORC1 | INSUFFICIENT DATA | VKORC1 not genotyped. Cannot provide genotype-guided warfarin dosing. Clinical testing recommended. |
...
```bash
python pharmgx_reporter.py --input warfarin_missing_vkorc1.txt --output report
```

**Input checksum**: `a5e24962b63d26f7a9fe76fce587ec5b92fefd2227ba8a1ca68d3842c35cc69b`
