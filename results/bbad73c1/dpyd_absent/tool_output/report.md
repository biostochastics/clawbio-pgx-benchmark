...
**Input**: `dpyd_absent.txt`
**Format detected**: unknown
**Checksum (SHA-256)**: `59580257df8ca7d3d2d31c36d4d8914b022aa5922c1a4963bf1e0c90129ef4e4`
...
**1 gene(s) could not be assessed** because the relevant SNPs were not found in the input file: DPYD
...
| DPYD | Dihydropyrimidine Dehydrogenase | NOT_TESTED | Indeterminate (not genotyped) |
...
| Capecitabine | Xeloda | Antineoplastic | DPYD | INSUFFICIENT DATA | Gene phenotype indeterminate (Indeterminate (not genotyped)). Cannot assess. |
| Fluorouracil | 5-FU | Antineoplastic | DPYD | INSUFFICIENT DATA | Gene phenotype indeterminate (Indeterminate (not genotyped)). Cannot assess. |
...
```bash
python pharmgx_reporter.py --input dpyd_absent.txt --output report
```

**Input checksum**: `59580257df8ca7d3d2d31c36d4d8914b022aa5922c1a4963bf1e0c90129ef4e4`
