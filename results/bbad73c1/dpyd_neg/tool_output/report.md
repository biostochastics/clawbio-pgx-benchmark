...
**Checksum (SHA-256)**: `5d468fa293e3f95d04bd5b5d08d7f7545f84805988cba5acae6995838d3fdbde`
...
```bash
python pharmgx_reporter.py --input dpyd_neg.txt --output report
```

**Input checksum**: `5d468fa293e3f95d04bd5b5d08d7f7545f84805988cba5acae6995838d3fdbde`
