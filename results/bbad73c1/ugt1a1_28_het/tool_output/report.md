...
**Input**: `ugt1a1_28_het.txt`
**Format detected**: unknown
**Checksum (SHA-256)**: `0093ff3eaac23986d093f4fe75893ca4ed59aac386debc8d4c75fefa1d8711f7`
...
| rs8175347 | UGT1A1 | *28 | CT | decreased_function |
...
```bash
python pharmgx_reporter.py --input ugt1a1_28_het.txt --output report
```

**Input checksum**: `0093ff3eaac23986d093f4fe75893ca4ed59aac386debc8d4c75fefa1d8711f7`
