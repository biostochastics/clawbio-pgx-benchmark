...
**Input**: `warfarin_missing_both.txt`
**Format detected**: unknown
**Checksum (SHA-256)**: `d6df399ca10e49daaf335b8f8a14709ebcd6f654dbc36e1375c8f75d3ac01e18`
**Total SNPs in file**: 27
**Pharmacogenomic SNPs found**: 27/30
**Genes profiled**: 12
**Drugs assessed**: 51
...
**2 gene(s) could not be assessed** because the relevant SNPs were not found in the input file: CYP2C9, VKORC1
...
| CYP2C9 | Cytochrome P450 2C9 | NOT_TESTED | Indeterminate (not genotyped) |
| VKORC1 | Vitamin K Epoxide Reductase | NOT_TESTED | Indeterminate (not genotyped) |
...
| Celecoxib | Celebrex | NSAID | CYP2C9 | INSUFFICIENT DATA | Gene phenotype indeterminate (Indeterminate (not genotyped)). Cannot assess. |
| Flurbiprofen | Ansaid | NSAID | CYP2C9 | INSUFFICIENT DATA | Gene phenotype indeterminate (Indeterminate (not genotyped)). Cannot assess. |
| Meloxicam | Mobic | NSAID | CYP2C9 | INSUFFICIENT DATA | Gene phenotype indeterminate (Indeterminate (not genotyped)). Cannot assess. |
| Phenytoin | Dilantin | Antiepileptic | CYP2C9 | INSUFFICIENT DATA | Gene phenotype indeterminate (Indeterminate (not genotyped)). Cannot assess. |
| Piroxicam | Feldene | NSAID | CYP2C9 | INSUFFICIENT DATA | Gene phenotype indeterminate (Indeterminate (not genotyped)). Cannot assess. |
| Warfarin | Coumadin | Anticoagulant | CYP2C9+VKORC1 | INSUFFICIENT DATA | CYP2C9 not genotyped. Cannot provide genotype-guided warfarin dosing. Clinical testing recommended. |
...
```bash
python pharmgx_reporter.py --input warfarin_missing_both.txt --output report
```

**Input checksum**: `d6df399ca10e49daaf335b8f8a14709ebcd6f654dbc36e1375c8f75d3ac01e18`
