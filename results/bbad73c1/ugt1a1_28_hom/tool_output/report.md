...
**Input**: `ugt1a1_28_hom.txt`
**Format detected**: unknown
**Checksum (SHA-256)**: `dbde705937f859d44e84bf5ee26944c7380f41ad42d61aa636c2786f9c422e4c`
...
| rs8175347 | UGT1A1 | *28 | TT | decreased_function |
...
```bash
python pharmgx_reporter.py --input ugt1a1_28_hom.txt --output report
```

**Input checksum**: `dbde705937f859d44e84bf5ee26944c7380f41ad42d61aa636c2786f9c422e4c`
